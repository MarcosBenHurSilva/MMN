...
namespace Bergs.Pxc.Pxcuocxn.Testes
{
    ...
    public class OperacaoCredTestesObter : OperacaoCredTestes
	{
       /// <summary> RN de Clientes e OperacaoCred </summary>
        ...
        public void Obter_Falha_OperacaoCredNull()
        {
            TOOperacaoCred toOperacaoCred = null;

            Retorno<TOOperacaoCred> retorno = this.RN.Obter(toOperacaoCred);
            MMAssert.IsFalse(retorno.OK);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Sucesso_Uma_OperacaoCred()
        {
            ...
            MMAssert.AreEqual(
                toOperacaoCred.NumContrato.LerConteudoOuPadrao(),
                retornoOperacaoCred.Dados.NumContrato.LerConteudoOuPadrao());
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Sucesso_OperacaoCred_Inexistente()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
            ...
            TOOperacaoCred toOperacaoCred = new TOOperacaoCred();
            toOperacaoCred.NumContrato = 80;

            Retorno<TOOperacaoCred> retornoOperacaoCred = this.RN.Obter(toOperacaoCred);
            MMAssert.FalhaObterInexistente(retornoOperacaoCred);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Falha_DataPrevistaFim_Inexistente_OperacaoCred_Solicitada()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
            ...
            MMAssert.IsFalse(toOperacaoCred.DataPrevistaFim.FoiSetado);
            MMAssert.IsFalse(toOperacaoCred.DataPrevistaFim.TemConteudo);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Sucesso_DataPrevistaFim_Correta_OperacaoCred_Contratada()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
            ...
            MMAssert.AreEqual(
                toOperacaoCred.DataPrevistaFim.LerConteudoOuPadrao(),
                //retornoOperacaoCred.Dados.DataPrevistaFim.LerConteudoOuPadrao()
                DateTime.Today.AddMonths(24).Date);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Sucesso_DataPrevistaFim_Correta_OperacaoCred_Encerrada()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
            ...
            MMAssert.AreEqual(
                toOperacaoCred.DataPrevistaFim.LerConteudoOuPadrao(),
                //retornoOperacaoCred.Dados.DataPrevistaFim.LerConteudoOuPadrao()
                DateTime.Today.AddMonths(96).Date);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Sucesso_SituacaoContrato_Solicitada_OperacaoCred()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
            ...
            MMAssert.AreEqual(
                toOperacaoCred.IndSituaco.LerConteudoOuPadrao(),
                //retornoOperacaoCred.Dados.IndSituaco.LerConteudoOuPadrao()
                SituacaoOperacao.Solicitada);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Sucesso_SituacaoContrato_Contratada_OperacaoCred()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
            ...
            MMAssert.AreEqual(
                toOperacaoCred.IndSituaco.LerConteudoOuPadrao(),
                //retornoOperacaoCred.Dados.IndSituaco.LerConteudoOuPadrao()
                SituacaoOperacao.Contratada);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Obter_Sucesso_SituacaoContrato_Encerrada_OperacaoCred()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
