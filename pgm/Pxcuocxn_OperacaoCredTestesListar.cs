...
namespace Bergs.Pxc.Pxcuocxn.Testes
{
    ...
    public class OperacaoCredTestesListar : OperacaoCredTestes
	{
        ...
        public void Listar_Falha_OpreacaoCredNull()
        {
            TOOpreacaoCred toOpreacaoCred = null;

            Retorno<TOOpreacaoCred> retorno = this.RN.Listar(toOperacaoCred, null);
            MMAssert.IsFalse(retorno.OK);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Listar_Sucesso_TodosOperacaoCred()
        {
            TOOperacaoCred toOperacaoCred = new TOOperacaoCred();
            //toOperacaoCred.NumContrato = 1;

            Retorno<TOOperacaoCred> retornoOperacaoCred = this.RN.Listar(toOperacaoCred, null);
            MMAssert.Sucesso(retornoOperacaoCred);
            MMAssert.AreEqual(
                6,
                retornoOperacaoCred.Dados.NumContrato.LerConteudoOuPadrao().Count);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Listar_Sucesso_Uma_OperacaoCred()
        {
        ...
        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Listar_Sucesso_OperacaoCred_Inexistente()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CNPJ_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Juridica;
