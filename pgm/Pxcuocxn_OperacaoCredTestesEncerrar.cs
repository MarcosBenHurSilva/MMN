...
namespace Bergs.Pxc.Pxcuocxn.Testes
{
    ...
    public class OperacaoCredTestesEncerrarOperacaoCred : OperacaoCredTestes
	{
        ...
        public void Encerrar_Falha_OperacaoCredNull()
        {
            TOOperacaoCred toOperacaoCred = null;

            Retorno<Int32> retorno = this.RN.Encerrar(toOperacaoCred);
            MMAssert.IsFalse(retorno.OK);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Encerrar_Sucesso_OperacaoCred_FISICO()
        {
            ...
            //toOperacaoCred.DataFim = DateTime.Today.Date;
            ...
            retornoOperacaoCred = this.RN.Obter(toOperacaoCred);
            MMAssert.Sucesso(retornoOperacaoCred);
            toOperacaoCredObter = retornoOperacaoCred.Dados;
            MMAssert.AreEqual(
                DateTime.Today.Date,
                toOperacaoCredObter.DataFim.LerConteudoOuPadrao());
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Encerrar_Sucesso_OperacaoCred_Juridico()
        {
            // TOClientePxc toCliente = new TOClientePxc();
        ...
        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Encerrar_Falha_Solicitada_OperacaoCred_FISICO()
        {
            //TOClientePxc toCliente = new TOClientePxc();
            ...
            MMAssert.FalhaComMensagem<Mensagem>(retorno, null , "Não é permitido encerrar Operação de Crédito já encerrada.");
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Encerrar_Falha_Encerrada_OperacaoCred_FISICO()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
