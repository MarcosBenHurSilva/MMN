...
namespace Bergs.Pxc.Pxcuocxn.Testes
{
    ...
    public class OperacaoCredTestesContratarOperacaoCred : OperacaoCredTestes
	{
        ...
        public void Contratar_Falha_OperacaoCredNull()
        {
            TOOperacaoCred toOperacaoCred = null;

            Retorno<Int32> retorno = this.RN.Contratar(toOperacaoCred);
            MMAssert.IsFalse(retorno.OK);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Contratar_Sucesso_OperacaoCred_FISICO()
        {
            ...
            //toOperacaoCred.DataInicio = DateTime.Today.Date;
            ...
            MMAssert.AreEqual(
                DateTime.Today.Date,
                toOperacaoCredObter.DataInicio.LerConteudoOuPadrao());
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Contratar_Sucesso_OperacaoCred_Juridico()
        {
            // TOClientePxc toCliente = new TOClientePxc();
        ...
        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Contratar_Falha_Contratada_OperacaoCred_FISICO()
        {
            //TOClientePxc toCliente = new TOClientePxc();
            ...
            MMAssert.FalhaComMensagem<Mensagem>(retorno, null , "Não é permitido contratar Operação de Crédito já contratada.");
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Contratar_Falha_Encerrada_OperacaoCred_FISICO()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
