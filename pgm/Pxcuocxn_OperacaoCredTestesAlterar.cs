...
namespace Bergs.Pxc.Pxcuocxn.Testes
{
    ...
    public class OperacaoCredTestesAlterar : OperacaoCredTestes
	{
        ...
        ///  <summary>
        /// Cobrir a Classe RegrasNegocio no testador
        /// </summary>
        protected override List<string> OutrasClassesParaGerarCobertura
        {
            get
            {
                return new List<string> { "RegrasNegocio" };
            }
        }
        #endregion
        ...
        public void Alterar_Falha_OperacaoCredNull()
        {
            TOOperacaoCred toOperacaoCred = null;

            Retorno<Int32> retorno = this.RN.Alterar(toOperacaoCred);
            MMAssert.IsFalse(retorno.OK);
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Sucesso_OperacaoCred_FISICO()
        {
            ...
            //toOperacaoCred.CodCliente = new CampoObrigatorio<String>();
            //toOperacaoCred.TipoPessoa = new CampoObrigatorio<TipoPessoa>();

            toOperacaoCred.ValorFinanciado = 4800000;
            ...
            //toOperacaoCred.CodCliente = toOperacaoCredObter.CodCliente;
            //toOperacaoCred.TipoPessoa = toOperacaoCredObter.TipoPesoa;

            toOperacaoCred.ValorFinanciado = toOperacaoCredObter.ValorFinanciado;
        ...
        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Sucesso_OperacaoCred_Juridico()
        {
            // TOClientePxc toCliente = new TOClientePxc();
        ...
        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Falha_ValorFinanciado_OperacaoCred_FISICO()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
            ...
            toOperacaoCred.ValorFinanciado = 999;
            ...
            MMAssert.FalhaComMensagem<Mensagem>(retorno, null , "Valor financiado deve ser maior ou igual a R$1.000 (mil reais).");

        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Falha_QtdeParcelas_100_OperacaoCred_FISICO()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
            ...
            toOperacaoCred.QtdeParcelas = 100;
            ...
            toOperacaoCred.QtdeParcelas = toOperacaoCredObter.QtdeParcelas;
            
            toOperacaoCred.UltAtualizacao = toOperacaoCredObter.UltAtualizacao;

            Retorno<Int32> retorno = this.RN.Alterar(toOperacaoCred);

            MMAssert.FalhaComMensagem<Mensagem>(retorno, null , "A quantidade de parcelas deve ser 1, 12, 24, 48 ou 96 apenas.");

        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Falha_QtdeParcelas_0_OperacaoCred_FISICO()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
        ...
        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Falha_QtdeParcelas_11_OperacaoCred_FISICO()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
            ...
            toOperacaoCred.QtdeParcelas = 11;
        ...
        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Falha_OperacaoCred_DataInicio()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
            ...
            TOOperacaoCred toOperacaoCred = new TOOperacaoCred();
            toOperacaoCred.NumContrato = 3;
            //toOperacaoCred.CodCliente = new CampoObrigatorio<String>();
            //toOperacaoCred.TipoPessoa = new CampoObrigatorio<TipoPessoa>();

            toOperacaoCred.DataInicio = DateTime.Today.AddDays(5).Date;
            ...
            toOperacaoCred.DataInicio = toOperacaoCredObter.DataInicio;

            toOperacaoCred.UltAtualizacao = toOperacaoCredObter.UltAtualizacao;

            Retorno<Int32> retorno = this.RN.Alterar(toOperacaoCred);

            MMAssert.FalhaComMensagem<Mensagem>(retorno, null , "Não é permitido alterar a Data de Início de uma Operação de Crédito.");
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Falha_OperacaoCred_DataFim()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
            ...
            TOOperacaoCred toOperacaoCred = new TOOperacaoCred();
            toOperacaoCred.NumContrato = 5;
            //toOperacaoCred.CodCliente = new CampoObrigatorio<String>();
            //toOperacaoCred.TipoPessoa = new CampoObrigatorio<TipoPessoa>();

            toOperacaoCred.DataFim = DateTime.Today.AddDays(15).Date;
            ...
            toOperacaoCred.DataFim = toOperacaoCredObter.DataFim;

            toOperacaoCred.UltAtualizacao = toOperacaoCredObter.UltAtualizacao;

            Retorno<Int32> retorno = this.RN.Alterar(toOperacaoCred);

            MMAssert.FalhaComMensagem<Mensagem>(retorno, null , "Não é permitido alterar a Data de Fim de uma Operação de Crédito.");
        }

        /// <summary>Teste</summary>
        [Test(Description = "Teste", Author = "B41660")]
        public void Alterar_Falha_Situacao_OperacaoCred_FISICO()
        {
            // TOClientePxc toCliente = new TOClientePxc();
            // toCliente.CodCliente = CPF_CLIENTE;
            // toCliente.TipoPessoa = TipoPessoa.Fisica;
            ...
            toOperacaoCred.QtdeParcelas = 96;
            ...
            MMAssert.FalhaComMensagem<Mensagem>(retorno, null , "Não é permitido alterar Operação de Crédito já contratadas.");
